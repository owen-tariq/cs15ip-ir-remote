...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bind(R.id.nextButton, 68, 100)      // next track — spam to skip forward
        bind(R.id.rewButton, 67, 100)       // previous song — spam to skip backward, same feel as NEXT
    ...
    /** Fires once on tap; while held, keeps re-sending every 150 ms (rewind/volume ramp). */
    @SuppressLint("ClickableViewAccessibility")
    private fun bindRepeating(viewId: Int, cmd: Int, address: Int) {
